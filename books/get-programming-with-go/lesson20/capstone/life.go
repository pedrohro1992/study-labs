...
// NewUniverse returns a empty universe
...
// Seed rando live cells into the universe.
...
// Alive reports whether the specified cell is allive.
// Uf the coordinates are outside of the universe, they wrap arround.
...
// Step updates the state of the next universe (b)
